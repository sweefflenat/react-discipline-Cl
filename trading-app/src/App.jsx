...
// Inspired by meditation app aesthetics: calm ocean gradients, soft glassmorphism
// ═══════════════════════════════════════════════════════════════════════════════
...
`;
  ...
  /* Streak card */
  .streak-card {
    background: linear-gradient(135deg, var(--white) 0%, var(--ocean-1) 100%);
    border-radius: 24px;
    padding: 22px;
    margin-bottom: 16px;
    display: flex;
  ...
  .streak-dot.filled {
    ...
    color: var(--white);
    box-shadow: 0 3px 12px rgba(78, 203, 160, 0.4);
  }
  ...
  .calendar-btn {
    ...
    box-shadow: 0 2px 8px rgba(42, 168, 208, 0.1);
  }
  ...
  .calendar-day:hover {
    background: rgba(42, 168, 208, 0.08);
  }
  ...
  /* Coach box */
  .coach-box {
    background: linear-gradient(135deg, var(--ocean-1) 0%, var(--ocean-2) 100%);
    border-radius: 20px;
    padding: 22px;
    margin-top: 16px;
  ...
  .plan-field-value.accent {
    color: var(--ocean-deep);
    font-weight: 700;
  }

  .plan-field-value.mono {
  ...
  .chip.selected {
    background: rgba(239, 123, 108, 0.15);
    color: #8b2a1d;
  ...
  .date-display {
    ...
    background: var(--white-90);
    border-radius: 12px;
    box-shadow: 0 2px 8px rgba(42, 168, 208, 0.08);
  }
  ...
  .history-item {
    ...
    justify-content: space-between;
    padding: 12px 0;
    border-bottom: 1px solid rgba(42, 168, 208, 0.08);
  }
  ...
  .bottom-nav-inner {
    ...
    justify-content: center;
    gap: 4px;
    box-shadow: 0 8px 40px rgba(42, 168, 208, 0.25),
  ...
  .nav-item.active {
    background: linear-gradient(135deg, var(--ocean-4) 0%, var(--ocean-5) 100%);
    box-shadow: 0 4px 16px rgba(74, 197, 232, 0.4);
  ...
  .nav-item.center {
    ...
    padding: 14px 22px;
    margin: -4px 2px;
    box-shadow: 0 6px 24px rgba(74, 197, 232, 0.45);
  }

  .nav-item.center:hover {
    transform: translateY(-2px);
    box-shadow: 0 8px 32px rgba(74, 197, 232, 0.55);
  }
